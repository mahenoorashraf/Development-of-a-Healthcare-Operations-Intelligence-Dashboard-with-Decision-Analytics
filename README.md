...
Dataset: Download medical_operations_master.csv from Google Drive

Quick Start
Open the live app link above
In the sidebar, upload medical_operations_master.csv
Use the sidebar filters and radio buttons to explore all 14 sections
Screenshots
...
Team
Team B - Batch 2 Individual task contributions merged into one unified Streamlit app, deployed on Streamlit Community Cloud.
